...
print1 db "Digite o X inicial:", 0h
...
print6 db "Sequencia de furos realizados:", 0ah, 0h
print7 db "Deseja inserir outras coordenadas?: (s) ou (n)", 0ah, 0h
printpar1 db "(", 0h
printv db ",", 0h
printpar2 db ")", 0ah ,0h
